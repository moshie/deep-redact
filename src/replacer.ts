...
export const replacer = (options: RedactOptions) => (_key: string, data: any) => {
    const {
        list = [],
        redactString = '[REACTED]'
    } = options;
    ...
    if (typeof data === 'object') {
        ...
        try {
            ...
            const convertedClassInstanceToPlainObject = JSON.parse(JSON.stringify(data));
